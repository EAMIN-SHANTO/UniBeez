...
import ShopRatingComponent from '../components/ShopRating';
import StarRating from '../components/StarRating';
import CustomProductRequestButton from '../components/CustomProductRequestButton';
              ...
              <div className="flex flex-col sm:flex-row">
                <div className="sm:w-1/3 mb-6 sm:mb-0 sm:pr-6">
                  ...
                  <div className="mt-4">
                    ...
                    {/* Add Shop Rating Component */}
                    {user && !isOwner && (
                      <div className="mt-4">
                        <ShopRatingComponent shopId={shop._id} shopOwnerId={shop.owner._id} />
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="sm:w-2/3">
                  ...
                  {/* Add Custom Product Request button if user is logged in and not the owner */}
                  {user && !isOwner && (
                    <div className="mb-6">
                      <CustomProductRequestButton 
                        shopId={shop._id}
                  ...
                  {/* Add link to Custom Product Requests Dashboard for shop owners */}
                  {isOwner && (
                    <div className="mb-6">
                      <Link
                        to={`/shops/${shop._id}/custom-requests`}
