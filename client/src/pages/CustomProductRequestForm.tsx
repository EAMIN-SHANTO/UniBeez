...
const CustomProductRequestForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Submitting custom product request with data:', {
        shopId,
        ...formData
      });
      ...
      console.log('Custom product request submission successful:', response.data);
      ...
      console.error('Custom product request submission error:', err);
      if (err.response) {
